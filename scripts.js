...
const totalPool = 59; 
const pairsCount = 8; const gameBoard = document.getElementById('game-board');
const bgMusic = document.getElementById('bg-music');
const moveDisplay = document.getElementById('move-counter');
const bestDisplay = document.getElementById('best-score');
const startBtn = document.getElementById('start-btn');
...
let showWomanNext = true; // Variable for alternating win screen
...
function initGame() {
    ...
    for (let i = 1; i <= totalPool; i++) {
        // Skip UI images and celebration images during deck creation
...
function handleWin() {
    ...
    // Alternating win screen logic
    const winContainer = document.getElementById('winner-image-container');
    if (showWomanNext) {
        winContainer.innerHTML = `<img src="img/58.png" alt="Celebration">`;
    } else {
        winContainer.innerHTML = `<img src="img/59.png" alt="Celebration">`;
    }
